<div class="w-full flex fixed z-[1000] left-0 bottom-0 flex justify-center">
    <div class="w-[600px] md:w-[500px] flex justify-around py-2 bg-slate-50 border-t-2">
        <a href="{{route('fireman.home')}}" class="{{url()->current() == route('fireman.home') ? "text-[#DC3545] font-bold" : "text-gray-400"}} font-poppins hover:text-[#DC3545] hover:font-bold flex flex-col justify-center items-center">
        ...
        <a href="{{route('fireman.report.view')}}" class="{{url()->current() == route('fireman.report.view') ? "text-[#DC3545] font-bold" : "text-gray-400"}}  font-poppins hover:text-[#DC3545] flex flex-col justify-center items-center">
        ...
        <a href="{{route('fireman.history')}}" class="{{url()->current() == route('fireman.history') ? "text-[#DC3545] font-bold" : "text-gray-400"}}  font-poppins hover:text-[#DC3545] flex flex-col justify-center items-center">
        ...
        <a href="{{route('notif.view')}}" class="relative {{url()->current() == route('notif.view') ? "text-[#DC3545] font-bold" : "text-gray-400"}} font-poppins hover:text-[#DC3545] flex flex-col justify-center items-center">
        ...
        <a href="{{route('fireman.profile')}}" class="{{url()->current() == route('fireman.profile') ? "text-[#DC3545] font-bold" : "text-gray-400"}} font-poppins hover:text-[#DC3545] flex flex-col justify-center items-center">
