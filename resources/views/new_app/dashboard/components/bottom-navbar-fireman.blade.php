<div class="w-full fixed z-[1000] left-0 bottom-0 flex justify-center">
    <div class="w-[600px] md:w-[500px] flex justify-around py-2 bg-slate-50 border-t-2 w-full">
        ...
        <a href="{{route('kontributor')}}" class="{{url()->current() == route('kontributor') ? "text-[#DC3545] font-bold" : "text-gray-400"}}  font-poppins hover:text-[#DC3545] flex flex-col justify-center items-center">
