...
@section('dashboard_js')
    <script>
        ...
        const templateReport = (data) => {
            ...
            switch (data.report_status) {
                case "dibatalkan":
                    ...
                    text =
                        `<a href="#" class="items-center border text-sm w-full text-center flex justify-center mt-6 py-[10px] rounded-full text-sm ${borderColor}  ${textColor}">Dibatalkan pada ${dateReport}</a>`;
                    break
                case "ditolak":
                    bgColor = "bg-[#F8D7DA]";
                    borderColor = "border-[#DC3545]"
                    textColor = "text-[#DC3545]"
                    text =
                        `<a href="#" class="items-center border text-sm w-full text-center flex justify-center mt-6 py-[10px] rounded-full text-sm ${borderColor}  ${textColor}">Ditolak pada ${dateReport}</a>`;
                    break
                case "selesai":
                    bgColor = "bg-[#D9F2E0]";
                    ...
                    text =
                        `<a href="#" class="items-center border text-sm w-full text-center flex justify-center mt-6 py-[10px] rounded-full text-sm ${borderColor}  ${textColor}">Selesai pada ${dateReport}</a>`;
                    break;
                default:
                    bgColor = "bg-blue-100";
                        ...
                        <div class="flex justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="text-slate-500 font-semibold text-sm">${data.user.name}</p>
                                </div>
                            </div>
                            <div
        ...
        const getReport = async (status) => {
            let errorBanner =
                `<p id="errorBanner" style="display: none" class="bg-slate-500 text-xs font-bold text-white rounded-lg py-4 text-center">Laporan kosong</p>`
