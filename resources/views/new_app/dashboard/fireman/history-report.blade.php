        ...
        const templateReport = (data) => {
            ...
            switch (data.report_status) {
                case "dibatalkan":
                    ...
                    text =
                        `<a href="{{route('fireman.detail.report',"/")}}/${data.id}" class="items-center border text-sm w-full text-center flex justify-center mt-6 py-[10px] rounded-full text-sm ${borderColor}  ${textColor}">Dibatalkan pada ${dateReport}</a>`;
                    break
                case "ditolak":
                    bgColor = "bg-[#F8D7DA]";
                    borderColor = "border-[#DC3545]"
                    textColor = "text-[#DC3545]"
                    text =
                        `<a href="{{route('fireman.detail.report',"/")}}/${data.id}" class="items-center border text-sm w-full text-center flex justify-center mt-6 py-[10px] rounded-full text-sm ${borderColor}  ${textColor}">Ditolak pada ${dateReport}</a>`;
                    break
                case "selesai":
                    bgColor = "bg-[#D9F2E0]";
                    ...
                    text =
                        `<a href="{{route('fireman.detail.report',"/")}}/${data.id}" class="items-center border text-sm w-full text-center flex justify-center mt-6 py-[10px] rounded-full text-sm ${borderColor}  ${textColor}">Selesai pada ${dateReport}</a>`;
                    break;
                default:
                    bgColor = "bg-blue-100";
