<div class="w-full fixed z-[1000] left-0 bottom-0 flex justify-center">
    <div class="w-[600px] md:w-[500px] flex justify-around py-2 bg-slate-50 border-t-2 w-full">
        <a href="{{route('fireman.home')}}" class="{{url()->current() == route('fireman.home') ? "text-yellow-500 font-bold" : ""}} font-poppins hover:text-yellow-500 hover:font-bold flex flex-col justify-center items-center">
        ...
        <a href="{{route('fireman.report')}}" class="{{url()->current() == route('fireman.report') ? "text-yellow-500 font-bold" : ""}} font-poppins hover:text-yellow-500 flex flex-col justify-center items-center">
        ...
        <a href="{{route('notif.view')}}" class="{{url()->current() == route('notif.view') ? "text-yellow-500 font-bold" : ""}} font-poppins hover:text-yellow-500 flex flex-col justify-center items-center">
        ...
        <a href="{{route('fireman.profile')}}" class="{{url()->current() == route('fireman.profile') ? "text-yellow-500 font-bold" : ""}} font-poppins hover:text-yellow-500 flex flex-col justify-center items-center">
